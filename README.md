...
- 📘 **Knowledge NPCs you can talk to** — beyond the taxi, the town has NPCs wired to live **MCP knowledge sources**. Walk up to the **MS Docs engineer** in the plaza and ask about Azure, .NET or Copilot — it answers straight from the **official Microsoft Learn docs, in real time** (keyless · free), with a trace panel linking every doc. Each NPC activates only **its own** MCP, turning the city into a hub of grounded experts.
