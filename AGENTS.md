...
| **`assets/repo-portal.js`** | Pure username/repository parser, route precedence, public projection, canonical Portal/Atelier/Blueprint links, and owner-town expansion link. | Changing `?repo=`, `?view=atelier`, accepted GitHub inputs, public traffic truth, or target/path share links. |
