...
| **`assets/repo-portal.js`** | Pure username/repository parser, route precedence, public projection, canonical Portal/Blueprint Deep Link URLs, and owner-town expansion link. | Changing `?repo=`, accepted GitHub inputs, public traffic truth, or target/path share links. |
