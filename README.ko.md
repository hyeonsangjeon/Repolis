...
- 🌳 **살아있는 도시** — **절차적으로 텍스처링된 집**(벽돌 · 사이딩 · 석재 · 슁글 지붕 — *이미지 에셋 0개*), 정원, **콜마르풍 꽃 마을**(쁘띠 베니스 운하 · 장미 아치 · 꽃수레 · 마켓 가판), **복슬복슬 차우차우 펫**, 가로수, 가로등, **앉았다 일어설 수 있는 쉼터 정자**, 그리고 가장 활발한 레포를 위한 **koi 연못과 차고**까지. 지붕 위 카테고리 로고(AI / Data / Software …)와 타운하우스 도로도 그대로.
