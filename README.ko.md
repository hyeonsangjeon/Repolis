...
- 📘 **말 걸 수 있는 지식 NPC** — 택시기사 말고도, 마을 NPC들이 라이브 **MCP 지식소스**에 연결돼 있어요. 광장의 **MS Docs 엔지니어**에게 다가가 Azure · .NET · Copilot을 물어보면 **Microsoft Learn 공식 문서에서 실시간으로**(키 불필요 · 무료) 답하고, 문서 링크 trace 패널까지 보여줘요. 각 NPC는 **자기 MCP만** 활성화해서, 도시가 grounded 전문가 허브가 됩니다.
